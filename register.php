...
<div id="particles-js">
    <div class="container-fluid position-relative">
        <div class="d-flex justify-content-center">
            <div class="card-xl position-absolute top-0" style="width: 400px; margin-top: 140px; padding: 40px; background-color: #222831;">
                ...
                <div class="py-3">
                    <center class="text-light fs-1">Sign Up</center >
                </div>
                <form action="./user/create_proses.php" method="POST" class="d-flex flex-column align-items-center align-content-center">
                    <div class="input-group my-2">
                        <span class="input-group-text" id="basic-addon1"><i class="fs-4 bi bi-person-check-fill"></i></span>
                        <input class="form-control" type="text" name="name" placeholder="Name">
                    </div>
                    <div class="input-group my-2">
                        <span class="input-group-text" id="basic-addon1"><i class="fs-4 bi bi-envelope-fill"></i></i></span>
                    ...
                    <div class="my-2">
                        <button class="btn text-light px-5" style="background-color: #00adb5;">Sign Up</button>
                    </div>
                    <div class="my-1">
                        <center class="text-light">Have Account ? <a class="text-decoration-none" href="index.php">Sign In</a></center>center>
                    </div>
                </form>
            </div>
        </div>
